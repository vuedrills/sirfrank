    ...
    <>
      {href && (text || Icon) && (
        <div className={twMerge('flex w-auto cursor-pointer', containerClass)}>
          {targetBlank ? (
            <Link
              className={twMerge('inline-flex items-center justify-center w-full hover:text-black bg-red-900 text-white sm:mb-0 dark:bg-red-900 dark:text-white', linkClass)}
              href={href}
              target="_blank"
